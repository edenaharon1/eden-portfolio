...
        // 💥 שינוי: הגדלת הנראות 
        color: {
          value: '#0ff', // שונה ל-**תכלת בולט** במקום אפור כהה (#4c4c99) 
        },
        distance: 150,
        enable: true,
        opacity: 0.8, // שונה מ-0.5 (שקיפות מופחתת -> נראות מוגברת)
        width: 1.5, // שונה מ-1 (קו עבה יותר)
      },
      move: {
        // תנועה איטית וטבעית
        direction: 'none',
...
      },
      size: {
        value: { min: 1, max: 6 }, // שונה מ-max: 5
      },
      // 💥 שינוי: הוספת אפקט זוהר/צל לנקודות עצמן
      shadow: {
        enable: true,
        blur: 10,
        color: '#0ff', // צל תכלת
